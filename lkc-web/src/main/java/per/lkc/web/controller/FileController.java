...
import per.lkc.web.service.FileService;
...
public class FileController {
    ...
    public void download(HttpServletRequest request, HttpServletResponse response,
        ...
        //文件位置
        File music = new File("/Users/ZhangJunbo/Movies/[电影天堂www.dy2018.net]龙纹身的女孩.720p.BD中英双字幕.rmvb");
    ...
    public void video(HttpServletRequest request, HttpServletResponse response) throws IOException {
        fileService.send(request, response);
    }
}
